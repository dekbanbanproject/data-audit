...
<body data-topbar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <header id="page-topbar">
            <div class="navbar-header" style="background-color: rgb(253, 10, 10)">
                <div class="d-flex">
                    <!-- LOGO -->
                    <div class="navbar-brand-box">
                        ...
                        <a href="{{ url('/') }}" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <h4 style="color:rgb(255, 255, 255)" class="mt-4">Data Audit</h4> 
                            </span>
                        </a>
                    </div>
                    ...
                    <form class="app-search d-none d-lg-block">
                        <div class="position-relative">
                            <h4 style="color:rgb(255, 255, 255)" class="mt-2">โรงพยาบาลส่งเสริมสุขภาพตำบลสนามชัย</h4>
                            {{-- @foreach ($org as $item) --}}
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="true">  
                                <li><a href="{{ url('ppfifyear') }}">คัดกรอง 15-34 ปี  </a></li>
                            </ul>
                        </li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            </script> © โรงพยาบาลส่งเสริมสุขภาพตำบลสนามชัย
                        </div>
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Created with <i class="mdi mdi-heart text-danger"></i> by Pradit Raha
                            </div>
                        </div>
                    </div>
                </div>
