...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="relative min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900"> 
            <div class="max-w-12xl mx-auto p-6 lg:p-12"> 
                        {{-- <a href="https://laravel-news.com" class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl     from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500"> --}}
                           <div class="card">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-md-6 text-center">
                                        <div class="input-daterange input-group" id="datepicker1" data-date-format="dd M, yyyy" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker6'>
                                            <input type="date" class="form-control" name="startdate" id="datepicker" placeholder="Start Date" data-date-container='#datepicker1'
                                             data-provide="datepicker" data-date-autoclose="true" data-date-language="th-th" value="{{ $start }}"/>
                                            <input type="date" class="form-control" name="enddate" placeholder="End Date" id="datepicker2" data-date-container='#datepicker1'
                            ...
                            <div class="card-body shadow-lg">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white"><button type="button" class="btn btn-info">15-34 ปี</button></h2>
                                            ...
                                            <table id="example" class="table table-hover">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="5%" class="text-center">age</th>                                        <th width="5%" class="text-center">pttype</th>               
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php $i = 1; ?>
